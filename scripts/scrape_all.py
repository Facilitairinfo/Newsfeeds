...
# -------------------------------
# Speciale scraper voor ISS Nederland – Nieuws en pers
# -------------------------------
def scrape_iss_nieuws():
    ...
    if not all_articles:
        print("❌ Geen nieuwsartikelen gevonden voor ISS Nederland")
        return

    rss_xml = build_rss(all_articles[:MAX_ITEMS])
...
def scrape_from_configs():
    ...
    for config_file in configs:
        # Sla de configs van WvN en ISS over; die doen we apart
